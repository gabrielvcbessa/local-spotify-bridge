...
MQTT_COMMAND_POLICIES: dict[str, MqttCommandPolicy] = {
    ...
    "shuffle_set": MqttCommandPolicy(follow_up_refresh=True, playback_affecting=True),
    "repeat_set": MqttCommandPolicy(follow_up_refresh=True, playback_affecting=True),
