...
class Settings(BaseSettings):
    ...
    bridge_build_commit: str = Field(default="", alias="BRIDGE_BUILD_COMMIT")
    bridge_build_ref: str = Field(default="", alias="BRIDGE_BUILD_REF")
    bridge_build_source: str = Field(default="", alias="BRIDGE_BUILD_SOURCE")
    bridge_profile_id: str = Field(default="default", alias="BRIDGE_PROFILE_ID")
    bridge_profile_name: str = Field(default="Local bridge", alias="BRIDGE_PROFILE_NAME")
    bridge_profile_registry_json: str = Field(default="", alias="BRIDGE_PROFILE_REGISTRY_JSON")
    ...
    spotify_playlist_poll_interval_seconds: float = Field(default=7200.0, alias="SPOTIFY_PLAYLIST_POLL_INTERVAL_SECONDS")
